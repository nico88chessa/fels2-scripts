        ...
        if sc==1:
            if numLaser == 1:
                ...
                for r in range(height):
                    ...
                    print("Creazione riga "+str(r)+"/"+str(height))
                ...
                destFile = currentPath + "/./output/1b-1laser.raw"
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/1b-8laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/1b-16laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/1b-32laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/1b-64laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
            ...
            if numLaser == 1:
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/GS8-1laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/GS8-2laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/GS8-4laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/GS8-8laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
            ...
            if numLaser == 1:
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/GS16-1laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/GS16-2laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
                ...
                currentPath = os.path.dirname(os.path.abspath(__file__))
                destFile = currentPath + "/./output/GS16-4laser.raw"
                with open(destFile, "wb") as f:
                    f.write(rawImage.tobytes())
